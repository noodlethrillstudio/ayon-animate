...
ANIMATE_ADDON_ROOT = os.path.dirname(os.path.abspath(__file__))


class AnimateAddon(AYONAddon, IHostAddon):
    name = "animate"
    version = __version__
    host_name = "animate"
    ...
    def get_launch_hook_paths(self, app):
        if app.host_name != self.host_name:
            return []
        return [
            os.path.join(ANIMATE_ADDON_ROOT, "hooks")
        ]
    ...
    #     from ayon_animate.api.lib import publish_in_test
